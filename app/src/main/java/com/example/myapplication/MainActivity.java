...
public class MainActivity extends AppCompatActivity {
    ...
    private void configurarSpinnersYTasas() {
        ...
        tasasDeCambio.put("MXN", 20.0);
        tasasDeCambio.put("CRC", 620.0);
        tasasDeCambio.put("GTQ", 7.75);
        tasasDeCambio.put("HNL", 24.0);
        tasasDeCambio.put("NIO", 35.0);
        tasasDeCambio.put("SVC", 8.75);
        tasasDeCambio.put("ARS", 95.0);
        tasasDeCambio.put("PEN", 3.8);
        tasasDeCambio.put("VES", 4.5);
